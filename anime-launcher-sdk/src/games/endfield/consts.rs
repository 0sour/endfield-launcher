...
pub const FOLDER_NAME: &str = "endfield-launcher";
...
///
/// If `LAUNCHER_FOLDER` variable is set, then its value will be returned. Otherwise return `$HOME/.local/share/endfield-launcher`
...
///
/// If `CACHE_FOLDER` variable is set, then its value will be returned. Otherwise return `$HOME/.cache/endfield-launcher`
...
///
/// Default is `$HOME/.local/share/endfield-launcher/config.json`
