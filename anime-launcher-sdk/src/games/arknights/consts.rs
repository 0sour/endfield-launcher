...
pub const FOLDER_NAME: &str = "arknights-launcher";
...
///
/// If `LAUNCHER_FOLDER` variable is set, then its value will be returned. Otherwise return `$HOME/.local/share/arknights-launcher`
...
///
/// If `CACHE_FOLDER` variable is set, then its value will be returned. Otherwise return `$HOME/.cache/arknights-launcher`
...
///
/// Default is `$HOME/.local/share/arknights-launcher/config.json`
