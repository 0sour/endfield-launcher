...
use anime_launcher_sdk::endfield::config::schema::launcher::LauncherStyle;
use anime_launcher_sdk::endfield::states::*;

use crate::*;
use crate::ui::components::*;
use super::preferences::main::*;
use super::about::*;
use switch_server::{SwitchServerDialog, SwitchServerDialogMsg};
...
relm4::new_stateless_action!(SwitchServer, WindowActionGroup, "switch_server");
...
pub static mut SWITCH_SERVER_DIALOG: Option<Controller<SwitchServerDialog>> = None;
...
impl SimpleComponent for App {
                        ...
                        adw::HeaderBar {
                            ...
                            set_title_widget = &adw::WindowTitle {
                                ...
                                set_title: match model.style {
                                    LauncherStyle::Modern => "Endfield Launcher",
                                    LauncherStyle::Classic => ""
                                }
                            },
    ...
    fn init(
        ...
        let switch_server_broker: MessageBroker<SwitchServerDialogMsg> = MessageBroker::new();
        ...
        unsafe {
            ...
            SWITCH_SERVER_DIALOG = Some(
                SwitchServerDialog::builder()
                    .transient_for(widgets.main_window.clone())
                    .launch_with_broker((), &switch_server_broker)
                    .detach()
            );
        }
        ...
        group.add_action::<SwitchServer>(RelmAction::new_stateless(move |_| {
            switch_server_broker.send(SwitchServerDialogMsg::Show);
        }));
        ...
        let download_picture = !KEEP_BACKGROUND_FILE.exists();
