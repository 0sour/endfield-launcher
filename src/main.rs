...
use anime_launcher_sdk::endfield::config::{Config, Schema};
use anime_launcher_sdk::endfield::states::LauncherState;
use anime_launcher_sdk::endfield::consts::*;
use anime_launcher_sdk::anime_game_core::prelude::*;
use anime_launcher_sdk::anime_game_core::endfield::prelude::*;
use anime_launcher_sdk::sessions::SessionsExt;
use anime_launcher_sdk::endfield::sessions::Sessions;
...
pub const APP_ID: &str = "moe.launcher.endfield-launcher";
pub const APP_RESOURCE_PATH: &str = "/moe/launcher/endfield-launcher";
...
lazy_static::lazy_static! {
    ...
    /// Path to launcher folder. Standard is `$HOME/.local/share/endfield-launcher`
    pub static ref LAUNCHER_FOLDER: PathBuf = launcher_dir().expect("Failed to get launcher folder");

    /// Path to launcher's cache folder. Standard is `$HOME/.cache/endfield-launcher`
    pub static ref CACHE_FOLDER: PathBuf = cache_dir().expect("Failed to get launcher's cache folder");

    /// Path to `debug.log` file. Standard is `$HOME/.local/share/endfield-launcher/debug.log`
    pub static ref DEBUG_FILE: PathBuf = LAUNCHER_FOLDER.join("debug.log");

    /// Path to `background` file. Standard is `$HOME/.local/share/endfield-launcher/background`
    pub static ref BACKGROUND_FILE: PathBuf = LAUNCHER_FOLDER.join("background");

    /// Path to `background-overlay` file. Standard is `$HOME/.local/share/endfield-launcher/background-overlay`
    pub static ref BACKGROUND_OVERLAY_FILE: PathBuf = LAUNCHER_FOLDER.join("background-overlay");

    /// Path to the processed `background` file. Standard is `$HOME/.cache/endfield-launcher/background`
    pub static ref PROCESSED_BACKGROUND_FILE: PathBuf = CACHE_FOLDER.join("background");

    /// Path to the processed `background-overlay` file. Standard is `$HOME/.cache/endfield-launcher/background-overlay`
    pub static ref PROCESSED_BACKGROUND_OVERLAY_FILE: PathBuf = CACHE_FOLDER.join("background-overlay");

    /// Path to the processed `background-video` file. Standard is `$HOME/.cache/endfield-launcher/background-video`
    ...
    ///
    /// Standard is `$HOME/.local/share/endfield-launcher/.keep-background`
    ...
    ///
    /// Standard is `$HOME/.local/share/endfield-launcher/.first-run`
...
fn print_help() {
    println!(r#"
Endfield Launcher {APP_VERSION}

Usage:
  endfield-launcher [OPTION...]
...
fn main() -> anyhow::Result<()> {
    ...
    gtk::glib::set_application_name("Endfield Launcher");
    gtk::glib::set_program_name(Some("Endfield Launcher"));
        ...
        if run_game || just_run_game {
            ...
            match state {
                LauncherState::Launch => {
                    anime_launcher_sdk::endfield::game::run().expect("Failed to run the game");
